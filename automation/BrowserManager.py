...
class Browser:
    ...
    # set the command sequence id corresponding to the url this browser browses next
    def set_command_sequence_id(self, command_sequence_id):
        self.browser_params['command_sequence_id'] = command_sequence_id
